...
<div class="form-group row">
    {{ Form::label('debut', 'Date Debut', [ 'class'=> 'col-sm-2 col-form-label' ] ) }}
    <datepicker :name="'debut'" :format="'yyyy-MM-dd'" :input-class="'col-sm-10 col-form-label'" ></datepicker>
</div>
<div class="form-group row">
    {{ Form::label('fin', 'Date Fin', [ 'class'=> 'col-sm-2 col-form-label' ]) }}
    <datepicker :name="'fin'" :format="'yyyy-MM-dd'" :input-class="'col-sm-10 col-form-label'" ></datepicker>
</div>
<div class="form-group row">
